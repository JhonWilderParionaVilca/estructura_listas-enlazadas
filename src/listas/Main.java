...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //listaSimple(e1, e2, e3, e4, e5);
        //listaDoble(e1, e2, e3, e4, e5);
        listaCircular(e1, e2, e3, e4, e5);
    }

    static void listaSimple(Estudiante e1, Estudiante e2, Estudiante e3, Estudiante e4, Estudiante e5) {
        /*
                                    Lista Simple
         */
        ...
        try {
            ...
            System.out.println(e);
            /*java.lang.Exception: No existe un nodo antes de {'e1', 'apell', 12}*/
        }
        try {
            /*eliminar antes del segundo*/
            estudiantes.eliminarAntesElementoBuscado(e2); //elimina e1
            System.out.println(estudiantes);
            /*primero->[{'e2', 'apell', 13}]->[{'e3', 'apell', 11}]->[{'e4', 'apell', 20}]-> null*/
 /*eliminar el final*/
        ...
        try {
            estudiantes.insertarFinal(e1);
            System.out.println(estudiantes);
            /*primero->[{'e1', 'apell', 12}]-> null*/

            //si hay un solo elemento
            estudiantes.insertarDespuesElementoBuscado(e1, e3);
            /*primero->[{'e1', 'apell', 12}]->[{'e3', 'apell', 11}]-> null*/
            System.out.println(estudiantes);
            //elemento esta al inicio
            estudiantes.insertarDespuesElementoBuscado(e1, e2);
            /*primero->[{'e1', 'apell', 12}]->[{'e2', 'apell', 13}]->[{'e3', 'apell', 11}]-> null*/
            System.out.println(estudiantes);
            //elemento esta al final
        ...
        try {
            ...
            System.out.println(estudiantes);
            /*java.lang.Exception: No hay un elemento despues de {'e4', 'apell', 20}*/
        } catch (Exception e) {
            System.out.println(e);
        }
        ...
        try {
            ...
            System.out.println(estudiantes);
            /*primero->[{'e1', 'apell', 12}]->[{'e2', 'apell', 13}]-> null*/
    ...
    static void listaDoble(Estudiante e1, Estudiante e2, Estudiante e3, Estudiante e4, Estudiante e5) {
        /*
                                    Lista doble
         */
        ...
        try {
            ...
            System.out.println(estudiantesD);
            /*primero y null <=>[{'e2'}]<=>[{'e3'}]<=>[{'e4'}]<=>[{'e5'}]-> nul*/
            estudiantesD.eliminarPrimero();
            System.out.println(estudiantesD);
            /*primero y null <=>[{'e3'}]<=>[{'e4'}]<=>[{'e5'}]-> null*/
            estudiantesD.eliminarPrimero();
            ...
            estudiantesD.eliminarPrimero();
            System.out.println(estudiantesD);
            /*java.lang.Exception: La lista esta vacia*/
        } catch (Exception e) {
            System.out.println(e);
        }
        ...
        try {
            ...
            System.out.println(estudiantesD);
            /*primero y null <=>[{'e1'}]<=>[{'e2'}]-> null*/
            estudiantesD.insertarFinal(e3);
            System.out.println(estudiantesD);
            /*primero y null <=>[{'e1'}]<=>[{'e2'}]<=>[{'e3'}]-> null*/
            estudiantesD.insertarFinal(e4);
            System.out.println(estudiantesD);
            /*primero y null <=>[{'e1'}]<=>[{'e2'}]<=>[{'e3'}]<=>[{'e4'}]-> null*/
            estudiantesD.insertarFinal(e5);
            System.out.println(estudiantesD);
            /*primero y null <=>[{'e1'}]<=>[{'e2'}]<=>[{'e3'}]<=>[{'e4'}]<=>[{'e5'}]-> null*/
            System.out.println("=> tamaño: " + estudiantesD.getTamanio());
        } catch (Exception e) {
        }
 ...
 /*elemento*/
            estudiantesD.insertarAntesElementoB(e1, e5);
            /*java.lang.Exception: No se encontro el elemento Buscado*/
        ...
        try {
            ...
            estudiantesD.eliminarAntesElementoB(e1);
            /*java.lang.Exception: No se puede eliminar antes del primer nodo*/
        } catch (Exception e) {
            System.out.println(e);
        }
 ...
 /*eliminar antes del ultimo*/
        ...
        try {
            ...
            estudiantesD.insertarDespuesElementoB(e1, e5);
            /*java.lang.Exception: La lista esta vacia*/
        } catch (Exception e) {
            System.out.println(e);
        }
 ...
 /*no se encuentra el elemento*/
        ...
        try {
            ...
            estudiantesD.eliminarDespuesElementoB(e4);
            /*java.lang.Exception: No se puede eliminar despues del ultimo nodo*/
        } catch (Exception e) {
            System.out.println(e);
        }
 ...
 /*no se encuentra el elemento*/
    ...
    static void listaCircular(Estudiante e1, Estudiante e2, Estudiante e3, Estudiante e4, Estudiante e5) {
        ...
        System.out.println("=> tamaño: " + estudiantesC.getTamanio()); //0
        ...
        try {
            ...
            System.out.println(estudiantesC);
            /*primero->[{'e4'}]->[{'e5'}]-> primero*/
            estudiantesC.insertarPrimero(e3);
            System.out.println(estudiantesC);
            /*primero->[{'e3'}]->[{'e4'}]->[{'e5'}]-> primero*/
            ...
            System.out.println("=> tamaño: " + estudiantesC.getTamanio()); //5
            
            //si ingreso duplicado
            estudiantesC.insertarPrimero(e5); /* El dato ya existe no se puede insertar datos duplicados*/
        } catch (Exception e) {
        ...
        try {
            ...
            /*si la lista esta vacia*/
            estudiantesC.eliminarPrimero();
            /*java.lang.Exception: No se puede eliminar. la lista esta vacia*/
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
        ...
        try {
            ...
            System.out.println(estudiantesC);
            /*primero->[{'e1'}]->[{'e2'}]-> primero*/
            estudiantesC.insertarFinal(e3);
            System.out.println(estudiantesC);
            /*primero->[{'e1'}]->[{'e2'}]->[{'e3'}]-> primero*/
            estudiantesC.insertarFinal(e4);
            System.out.println(estudiantesC);
            /*primero->[{'e1'}]->[{'e2'}]->[{'e3'}]->[{'e4'}]-> primero*/
            estudiantesC.insertarFinal(e5);
            System.out.println(estudiantesC);
            /*primero->[{'e1'}]->[{'e2'}]->[{'e3'}]->[{'e4'}]->[{'e5'}]-> primero*/
        } catch (Exception e) {
            System.out.println(e);
        }
        ...
        try {
            ...
            /*java.lang.Exception: No se puede eliminar elelemnto buscado en lista vacia*/
        } catch (Exception e) {
            System.out.println(e);
        }
        ...
        try {
            ...
            estudiantesC.insertarPrimero(e2);
            estudiantesC.insertarPrimero(e1);
            System.out.println(estudiantesC); /*primero->[{'1'}]->[{'2'}]->[{'3'}]->[{'4'}]-> primero*/
            System.out.println("=> tamaño: " + estudiantesC.getTamanio());

            /*Eliminar primero*/
            estudiantesC.eliminarElementoBuscado(e1);
            System.out.println(estudiantesC);
            /*primero->[{'e2'}]->[{'e3'}]->[{'e4'}]-> primero*/

            /*eliminar intermedio*/
            estudiantesC.eliminarElementoBuscado(e3);
            System.out.println(estudiantesC);
            /*primero->[{'e2'}]->[{'e4'}]-> primero*/
 ...
 /*eliminar 1 solo nodo*/
        ...
        try {
            /*Lista vacia*/
            System.out.println("=> tamaño: " + estudiantesC.getTamanio());
            estudiantesC.insertarAntesElementoB(e1, e5);
            /*java.lang.Exception: no se puede insertar antes de una lista vacia*/
        } catch (Exception e) {
            System.out.println(e);
        }
 ...
 /*insertar antes intermedio*/
        ...
        try {
            ...
            estudiantesC.eliminarAntesElementoB(e1);
            /*java.lang.Exception: No existe un nodo antes de {'e1'}*/
        } catch (Exception e) {
            System.out.println(e);
        }
 ...
 /*eliminar tercero*/
            ...
            estudiantesC.eliminarAntesElementoB(e4);
            /*java.lang.Exception: No existe un nodo antes de {'e4'}*/
        } catch (Exception e) {
            System.out.println(e);
        }
